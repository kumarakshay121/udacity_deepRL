...
3. Place the file in this repository, in the `p1_navigation/` folder, and unzip (or decompress) the file.
...
1. Open the `Navigation.ipynb` notebook to get started with training your own agent!
